/**
 * Premium Order Delivered Template
 */
const orderDeliveredTemplate = (name, orderId, restaurantName, totalAmount) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <style>
            ...
            .success-card { background-color: #f0fdf4; border-radius: 20px; padding: 32px; border: 1px solid #dcfce7; margin: 32px 0; text-align: center; }
    ...
    <body>
        <div class="wrapper">
            <table class="main">
                ...
                <tr>
                    <td class="content">
                        <h1>Delivered & Enjoyed! 🍽️</h1>
                        <p>Hello ${name}, your order from <strong>${restaurantName}</strong> has been successfully delivered. We hope you enjoy every bite!</p>
                        ...
                        <div class="success-card">
                            ...
                            <p style="margin-top: 16px; font-weight: 700; color: #166534;">Delivered successfully</p>
                        </div>

                        <div class="cta-container">
                            <a href="http://localhost:5173/orders" class="button">Rate Your Experience</a>
                        </div>
                        
                        <p style="margin-top: 40px; font-size: 14px; color: #64748b;">
                            How was the food? Your feedback helps us improve.<br>
