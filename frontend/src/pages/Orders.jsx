  ...
  return (
    <div className="max-w-5xl mx-auto pb-20 animate-fadeIn px-4 sm:px-0">
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-8 sm:mb-10">
        <h1 className="text-3xl sm:text-4xl font-black text-gray-800 italic tracking-tight">My Orders</h1>
      ...
      <div className="space-y-6 sm:space-y-8">
        {orders.map((order) => {
          ...
          return (
            <div key={order._id} className="bg-white rounded-2xl sm:rounded-[32px] shadow-xl border border-gray-50 overflow-hidden group">
              {/* Order Header */}
              <div className="p-5 sm:p-8 border-b border-gray-50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-50/30">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-black text-gray-800 tracking-tight group-hover:text-primary transition-colors line-clamp-1">
                      {order.restaurantId?.name || 'Restaurant'}
                    </h3>
                    <p className="text-[10px] sm:text-xs text-gray-400 font-bold uppercase tracking-widest flex items-center gap-1 mt-0.5 sm:mt-1">
              ...
              <div className="p-5 sm:p-8">
                  ...
                  {order.items.map((item, idx) => (
                    <div key={idx} className="flex justify-between items-center gap-4">
                      <div className="flex items-center gap-3 min-w-0">
                        <span className="w-6 h-6 bg-gray-100 rounded-lg flex items-center justify-center text-[10px] font-black text-gray-500 shrink-0">{item.quantity}x</span>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pt-5 sm:pt-6 border-t border-dashed border-gray-100">
