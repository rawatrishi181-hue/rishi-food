...
const addToCart = async (req, res) => {
    try {
        ...
        if (!cart) {
            ...
            if (cart.items.length > 0 && cart.restaurantId.toString() !== food.restaurantId.toString()) {
                // Option: Reject request with message
                return sendError(res, 400, 'Cart already contains items from another restaurant. Please clear your cart first.');
            }
