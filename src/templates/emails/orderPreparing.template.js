/**
 * Premium Order Preparing Template
 */
const orderPreparingTemplate = (name, orderId, restaurantName) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <style>
            ...
            .prep-card { background-color: #fffbeb; border-radius: 20px; padding: 32px; border: 1px solid #fef3c7; margin: 32px 0; text-align: center; }
            .prep-icon { font-size: 48px; margin-bottom: 16px; }
            ...
            .button { background-color: #f59e0b; color: #ffffff !important; padding: 18px 36px; border-radius: 16px; font-weight: 700; text-decoration: none; display: inline-block; }
            ...
            <table class="main">
                ...
                <tr>
                    <td class="content">
                        ...
                        <p>Hang tight, ${name}! The chefs at <strong>${restaurantName}</strong> are currently busy preparing your fresh and hot meal. We'll let you know when it's ready to travel.</p>
                        ...
                        <div class="prep-card">
                            ...
                            <p style="margin-top: 16px; font-weight: 700; color: #92400e;">Estimated prep time: 15-20 mins</p>
                        </div>

                        <div class="cta-container">
                            <a href="http://localhost:5173/orders" class="button">Track Progress</a>
                        </div>
...
module.exports = orderPreparingTemplate;
